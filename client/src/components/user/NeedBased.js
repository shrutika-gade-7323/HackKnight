...
import needBasedScholarshipData from './data/needBasedScholarshipData'; // Assuming scholarship data is in a separate file
...
const NeedBased = () => {
  ...
  const filteredScholarships = needBasedScholarshipData.filter((scholarship) =>
