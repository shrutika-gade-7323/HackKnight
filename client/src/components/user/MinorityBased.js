...
import minorityBasedScholarshipData from './data/minorityBasedScholarshipData'; // Assuming scholarship data is in a separate file
...
const MinorityBased = () => {
  ...
  const filteredScholarships = minorityBasedScholarshipData.filter((scholarship) =>
